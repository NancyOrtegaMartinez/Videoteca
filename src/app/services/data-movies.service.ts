...
export class DataMoviesService {
  ...
  getDiscover() {
    ...
    //segundo camio
    return this.http.get<ResultTMDB>('https://api.themoviedb.org/3/discover/movie?api_key=dd6437535543edca1fc1203c913c80c9&language=es&primary_release_date.gte=2022-03-01&primary_release_date.lte=2022-03-31')
  }
}